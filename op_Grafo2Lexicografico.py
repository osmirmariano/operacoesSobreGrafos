...
#CALCULANDO GRAFO 2 LEXICOGRÁFICO - AULA 12 
#---------------------------------------------------------------------------------------
g = Graph({'AE':['BE','CE','CF','BF','CG','BG'],'BE':['AE','AF','AG','BE','CE','CG'],'CE':['AE','BE','AF','AG','BF','BG'],'AF':['BE','CE','CF','BF','CG','AG'],'BF':['AE','AF','AG','BG','CG','CF','CE'],'CF':['BE','AE','BF','AF','AG','BG','CG'],'AG':['AF','BE','CE','BF','CF','CG','BG'],'BG':['AF','AE','BF','CF','CG','CG'],'CG':['AG','BG','AF','AE','BF','BE','CF']})
execute(g,[3,3])
