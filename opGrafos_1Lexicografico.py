...
#-----------------INÍCIO GRAFO 01 - PRODUTO LEXIGRÁFICO --------------------------------------
print "------------------------ PRODUTO LEXICOGRAFICO -------------------------------"
node = {'AF':['AE','AG','BE','BF','BG'],'AE':['BE','BF','BG'],'AG':['BE','BF','BG'],'BE':['BF','CE','CF','CG'],'BF':['BG','CE','CF','CG'],'BG':['CE','CF','CG'],'CE':['CF','DE','DF','DG'],'CF':['CG','DE','DF','DG'],'CG':['DE','DF','DG'],'DE':['DF'],'DF':['DG']}
